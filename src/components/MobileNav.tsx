  ...
  if (!isOpen)
    return (
      <button
        ...
        className="md:hidden relative -m-2 mr-2 inline-flex items-center justify-center rounded-md p-2 text-gray-400"
      >
  ...
  return (
    <div>
      ...
      <div className="fixed overflow-y-scroll overscroll-y-none inset-0 z-40 flex justify-end">
        <div className="w-4/5">
          <div className="relative float-right flex w-full max-w-sm flex-col overflow-y-auto bg-white pb-12 shadow-xl">
